 ...
 *    2. DELETE /api/posts/:id/like     - current user un-likes a post
 *
 *  CRITICAL — keep Post.likeCount in sync:
 *    Each like creation increments Post.likeCount by 1.
 *    Each like deletion decrements Post.likeCount by 1.
 *    Use $inc, never compute from scratch — multiple users may like at once.
 *
 *  IDEMPOTENCY:
 *    The (userId, postId) pair on Like is uniquely indexed (see models/Like.js).
